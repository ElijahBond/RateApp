...
loginHandler = async () =>{
  ...
  try{
    const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCVQPAZvc4s2M7__UtVpw1WEhFbMvUGpxE', authData)
...
registerHandler = async () =>{
  ...
  try{
    const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCVQPAZvc4s2M7__UtVpw1WEhFbMvUGpxE', authData)
...
dataWrite = async () =>{
 ...
 await fetch(`https://api.apilayer.com/exchangerates_data/${this.state.sample.date}?symbols=${this.state.sample.base2}&base=${this.state.sample.base}`, {
    headers: {
      'apikey' : "8SBHXfTt5cbOFFobB5mljCBMIcDpLtg3"
    }
  })
...
await  axios.post('https://rate-app-88cf2-default-rtdb.firebaseio.com/sample.json', this.state.sample)
.then((response) =>{
  return('')
})

await axios('https://rate-app-88cf2-default-rtdb.firebaseio.com/sample.json')
.then((response) =>{
...
sampleRemove = async (id) =>{
 ...
 await axios.delete(`https://rate-app-88cf2-default-rtdb.firebaseio.com/sample/${id}.json`)
...
calculatorHandler = async (value) => {
  ...
  await fetch(`https://api.apilayer.com/exchangerates_data/latest?base=RUB`, {
    headers: {
      'apikey' : "8SBHXfTt5cbOFFobB5mljCBMIcDpLtg3"
    }
  })
...
componentDidMount(){
  ...
  fetch(`https://api.apilayer.com/exchangerates_data/latest?base=${this.state.base}`, {
    headers: {
      'apikey' : "8SBHXfTt5cbOFFobB5mljCBMIcDpLtg3"
    }})
  .then((response)=> response.json())
  .then((response)=>{
    ...
    axios('https://rate-app-88cf2-default-rtdb.firebaseio.com/sample.json')
    .then((response) =>{
      this.setState({sampleList: response.data})
})
